...
DATA_OBAT_CSV = os.path.abspath("data_obat.csv")
DATA_RACIKAN_CSV = os.path.abspath("data_racikan.csv")
...
def muat_data():
    ...
    try:
        ...
        data_obat = pd.DataFrame(columns=['Nama Obat', 'Harga', 'Tanggal Kadaluarsa', 'Produsen', 'Dosis'])
...
def tambah_data_obat():
    ...
    # Menambahkan informasi produsen dan dosis
    produsen = input("Masukkan produsen obat: ")
